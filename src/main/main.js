...
app.whenReady().then(async () => {
  try {
    ...
    ipcMain.handle('db:addQuestion', async (_, quizId, text, opt_a, opt_b, opt_c, opt_d, correct_opt, image, image_width, image_height) => {
      return await dbApi.addQuestion(quizId, text, opt_a, opt_b, opt_c, opt_d, correct_opt, image, image_width, image_height);
    });

    ipcMain.handle('db:updateQuestion', async (_, id, text, opt_a, opt_b, opt_c, opt_d, correct_opt, image, image_width, image_height) => {
    return await dbApi.updateQuestion(id, text, opt_a, opt_b, opt_c, opt_d, correct_opt, image, image_width, image_height);
  });
